...
export default function createVroom<Options extends Settings & { models: any }>(options: Options) {
    ...
    const stores = createStores<ModelTypes, Options['models']>(models, settings.baseURL);
